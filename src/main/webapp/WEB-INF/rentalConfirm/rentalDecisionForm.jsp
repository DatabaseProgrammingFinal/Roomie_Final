...
<body>
					...
					<div class="input-group">
						...
						<div class="select-container">
							<img src="${pageContext.request.contextPath}/images/roomie.png"
								alt="room_numberie Icon" class="room_numberie-img"> 
								<select id="store" nickname="store">
								<option value="store">${store}루미</option>
				...
				<div class="location-group">
					<div class="input-group">
						<label for="rental-place">대여 장소</label> <input type="text"
							id="rental-place" nickname="rental-place"  value="${rental_place}"
							 placeholder="대여 장소 입력">
					</div>
					<div class="input-group">
						<label for="return-place">반납 장소</label> <input type="text"
							id="return-place" nickname="return-place" value="${return_place}" placeholder="반납 장소 입력">
					</div>
				</div>
				...
				<div class="date-group">
					<div class="input-group">
						<label for="rental-date">대여 날짜</label> <input type="date"
							id="rental-date" nickname="rental-date" value="${rental_date}">
					</div>
					<span class="date-separator">~</span>
					<div class="input-group">
						<label for="return-date">반납 날짜</label> <input type="date"
							id="return-date" nickname="return-date" value="${return_date}">
					</div>
				</div>

				<button class="start-rental-btn" onclick="redirectToViewConfirm()">대여
					시작</button>
			</div>
	...
	<script>
    function redirectToViewConfirm() {
    	window.location.href = '${pageContext.request.contextPath}/confirm/view';
    }
    </script>
</body>
</html>