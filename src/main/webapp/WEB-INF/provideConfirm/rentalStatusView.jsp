...
<body>
	<div class="container">
		...
		<div class="content">
			...
			<div class="form-container">
					...
					<div class="input-group">
						...
						<div class="select-container">
							<img src="${pageContext.request.contextPath}/images/roomie.png"
								alt="room_numberie Icon" class="room_numberie-img"> <select
								id="store">
								<option value="${store}"
				...
				<button class="start-rental-btn" onclick="redirectToReturnConfirm()">반납
					진행</button>
			</div>
	...
	<script>
		function redirectToReturnConfirm() {
			...
			if (provideConfirmId) {
				window.location.href = '${pageContext.request.contextPath}/provideConfirm/return?provideConfirmId='
						+ provideConfirmId;
			} else {
