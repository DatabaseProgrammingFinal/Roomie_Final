	...
	<div class="container">
		<div class="content">
            ...
            <div class="footer">
                ...
                <button class="send-msg-btn" onclick="location.href='${pageContext.request.contextPath}/message/chat?sender=${sessionScope.userId}&recipientId=${post.requesterId}&postId=${post.id}&postType=request'">>쪽지 보내기</button>
            </div>
        </div>
    </div>
    <script>
