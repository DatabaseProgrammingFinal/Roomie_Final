        ...
        <div class="content">
            ...
            <div class="body">
                <div class="button-container">
                    ...
                    <button class="button-prov"  onclick="goToProvidePost()">물건 제공해요</button>
                </div>

                <!-- Search Bar Form -->
                <div class="search-bar">
                    <form action="${pageContext.request.contextPath}/requestpost/search" method="get"  id="searchform">
