...
<title>Roomie</title>
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/provide/view_provide.css">
</head>
<body>
	<div class="container">
		<div class="content">
			...
			<div class="body">
				<div class="title-container">
					...
					<img src="${image_url}/images/menu.png" alt="Menu" class="menu-img"
				...
				<div class="item-info">
					<div class="info-row">
						<span class="label">물품명</span> <span class="value">${post.rental_item}</span>
					</div>
					<div class="info-row">
						<span class="label">대여 장소</span> <span class="value">${post.rental_location}</span>
					</div>
					<div class="info-row">
						<span class="label">반납 장소</span> <span class="value">${post.rental_location}</span>
					</div>
					<div class="info-row">
						<span class="label">대여 날짜</span> <span class="value">${post.rental_start_date}
							~ ${post.rental_end_date}</span>
					</div>
				</div>
			</div>
