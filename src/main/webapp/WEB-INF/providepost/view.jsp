	...
	<div class="container">
		<div class="content">
			...
			<div class="footer">
				...
				<!-- 로그인한 사용자와 작성자가 동일하지 않을 때만 버튼 표시 -->
					<button class="send-msg-btn"
						onclick="location.href='${pageContext.request.contextPath}/message/chat?sender=${sessionScope.userId}&recipientId=${post.providerId}&postId=${post.id}&postType=provide'">
						쪽지 보내기</button>
			</div>
