		...
		<div class="content">
			...
			<div class="body">
				<div class="button-container">
					<button class="button-req" onclick="goToRequestPostCreate()">물건
						필요해요</button>
				...
				<div class="form-container">
					<form
						action="${pageContext.request.contextPath}/providepost/create"
						method="post">
						...
						<div class="input-group price-item-group">
							<div class="price-item">
								...
								<div class="select-container">
									<img src="${pageContext.request.contextPath}/images/roomie.png"
										alt="Point" class="roomie-img" width="24px"> <select
							...
							<div class="item-nickname">
								<label for="rentalItem">물품명</label> <input type="text"
									id="rentalItem" name="rentalItem" required>
							</div>
						</div>
						...
						<div class="input-group location-group">
							<div class="rental-place">
								<label for="rentalLocation">대여 장소</label> <input type="text"
									id="rentalLocation" name="rentalLocation" required>
							</div>

							<div class="return-place">
								<label for="returnLocation">반납 장소</label> <input type="text"
									id="returnLocation" name="returnLocation" required>
							</div>
						</div>
						...
						<div class="input-group date-group">
							<div class="rental-date">
								<label for="startDate">대여 시작일</label> <input type="date"
							...
							<div class="return-date">
								<label for="endDate">반납 날짜</label> <input type="date"
