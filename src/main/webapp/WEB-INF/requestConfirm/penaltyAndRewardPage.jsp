...
<body>
	...
	<script>
		function redirectToUpdatePoints() {
			const requestConfirmId = '${requestConfirmId}'; // 서버에서 전달된 requestConfirmId
			if (requestConfirmId) {
				window.location.href = '${pageContext.request.contextPath}/requestConfirm/updatePoints?requestConfirmId=' + requestConfirmId;
			} else {
