...
<body>
	<div class="container">
		...
		<div class="content">
			...
			<!-- Editable Fields -->
			<!-- 추가된 form 태그 -->
			<form action="${pageContext.request.contextPath}/requestConfirm/update"
				method="post">
				<input type="hidden" name="requestPostId" value="${requestPostId}">
				<input type="hidden" name="requestConfirmId"
					value="${requestConfirmId}">
