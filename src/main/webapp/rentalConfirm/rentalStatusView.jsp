...
<head>
    ...
    <title>Roomie</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/provideConfirm/rentalDecisionForm.css">
</head>
<body>
    <div class="container">
        <!-- 상단 (Header) -->
        ...
        <div class="content">
            ...
            <div class="info">
                ...
                <div class="info-row">
                    ...
                    <span class="value" id="provider">${provider}</span> <!-- 서버에서 전달된 제공자 -->
                </div>
                <div class="info-row">
                    <span class="label">대여 요청자</span>
                    <span class="value" id="requester">${requester}</span> <!-- 서버에서 전달된 요청자 -->
                </div>
            </div>
            ...
            <div class="form-container">
                ...
                <div class="location-group">
                    <div class="input-group">
                        ...
                        <input type="text" id="rental-place" placeholder="대여 장소 입력" value="${rentalPlace}">
                    </div>
                    <div class="input-group">
                        <label for="return-place">반납 장소</label>
                        <input type="text" id="return-place" placeholder="반납 장소 입력" value="${returnPlace}">
                    </div>
                </div>
                ...
                <div class="date-group">
                    <div class="input-group">
                        ...
                        <input type="date" id="rental-date" value="${rentalDate}">
                    </div>
                    <span class="date-separator">~</span>
                    <div class="input-group">
                        <label for="return-date">반납 날짜</label>
                        <input type="date" id="return-date" value="${returnDate}">
                    </div>
                </div>
